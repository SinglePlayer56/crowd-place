...
export async function generateMetadata({searchParams, params}: SearchParams<PageProps>): Promise<Metadata> {
    ...
    const canonicalSearchParams = `${process.env.DOMAIN}/fr/blog/${params.category}/?page=${searchParams.page}`
    ...
    return {
        ...
        alternates: {
            canonical: !searchParams.page ? `${process.env.DOMAIN}/fr/blog/${params.category}/` : canonicalSearchParams
        }
    };
}
