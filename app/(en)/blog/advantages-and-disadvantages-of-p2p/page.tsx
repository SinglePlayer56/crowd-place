...
import {ArticleImage, BreadCrumbs, HTag, InterestingPosts, PTag, Tag} from "@/components";
...
const ArticlePage = async () => {
    ...
    const paramsBreadCrumbs = [
        {name: 'Main', href: ''},
        {name: 'Blog', href: 'blog'},
        {name: 'Advantages and Disadvantages of peer-to-peer lending', href: post.slugHref},
    ];
